CLUT2 - PlayStation2 ColorLookUpTable - File Format Specification
                [PRELIMINARY, CONFIDENTIAL]

                                                                     99/11/18
                                                         web technology Corp.

Sample program for CLUT2 format


This program is a sample program for CLUT2 format as a reference.
...
with a documentation of CLUT2 format specifications, specifications takes precedence
...
tim2clut program retrieves CLUT part of a TIM2 file, and converts it into CLUT2 file.
This program is for Win32 environment.

tim2.h:       Header file defines the structure of file header, picture header etc.

tim2clut.c:   Body of the program


<About support of CLUT2 format>
